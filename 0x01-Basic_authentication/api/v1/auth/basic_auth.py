...
class BasicAuth(Auth):
    ...
    def extract_user_credentials(
        ...
        if (decoded_base64_authorization_header is 
            None or not isinstance(decoded_base64_authorization_header, str)):
            return None, None
    ...
    def require_auth(self, path: str, excluded_paths: List[str]) -> bool:
        ...
        if (path is None or not isinstance(path, str) or excluded_paths is
            None or not all(isinstance(p, str) for p in excluded_paths)):
            return True
